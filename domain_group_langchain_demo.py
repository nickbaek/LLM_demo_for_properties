...
class PropDataAgent:
    ...
    def initialize_chat_agent(self, chat_model):
        ...
        system_message = f"""
            You are a knowledgeable assistant that helps a real eastate company.
        ...
        agent = create_react_agent(
            llm, self.tools, prompt=system_message, checkpointer=memory, debug=False
        )
        return agent
    ...
    def start_chat(self):
        ...
        self.color_print(
            "Welcome to the Property Data Agent service. I can give you any insights related to real estate Properties. \n",
            "instruction",
        )
        self.color_print(
            "####################################################################################\n",
